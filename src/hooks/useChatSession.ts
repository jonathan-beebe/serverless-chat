...
// RFCTR-004: telemetry types + math now live in src/core/telemetry. Re-export
// for legacy consumers (Network.tsx, Network.test.tsx) so the hook's public
// surface stays unchanged.
export type { NetworkTelemetry, TelemetrySample, TelemetrySummary }
